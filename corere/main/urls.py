...
urlpatterns = [
    ...
    path(
        "manuscript/<int:id>/update/", classes.ManuscriptUpdateView.as_view(), name="manuscript_update"
    ),  # almost same as edit but part of create submission flow
    ...
    path("manuscript/<int:id>/renamefile/", classes.ManuscriptRenameFileView.as_view(), name="manuscript_renamefile"),
    ...
    path(
        "manuscript/<int:id>/confirm/",
        classes.ManuscriptEditConfirmBeforeDataverseUploadView.as_view(),
    ...
    path(
        "submission/<int:id>/confirmfiles/",
        classes.SubmissionCompleteFilesBeforeDataverseUploadView.as_view(),
        name="submission_confirmfilesbeforedataverseupload",
    ),
    ...
    path("submission/<int:id>/renamefile/", classes.SubmissionRenameFileView.as_view(), name="submission_renamefile"),
    ...
    path(
        "submission/<int:id>/notebooklogin/", classes.SubmissionNotebookRedirectView.as_view(), name="submission_notebooklogin"
    ),  # Technically this page is more than login, but login is a good user facing name
