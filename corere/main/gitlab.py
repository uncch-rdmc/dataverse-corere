...
# from corere.main import models as m #TODO: Switch to GitFile
...
# #TODO: Investigate getting all current and previous submission GitFiles in one query https://stackoverflow.com/questions/35314346/performance-optimization-on-django-update-or-create
...
#     cur_sub_files = m.GitFile.objects.filter(parent_submission=submission)
...
#         prev_sub_files = m.GitFile.objects.filter(parent_submission=prev_submission.id)
