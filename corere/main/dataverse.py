...
# Title, Author, Contact, Description, Subject
...
def build_dataset_json(manuscript):
    ...
    # TODO: Can I use an inline loop to populate the needed arrays? If it gets too crazy I can populate the arrays after
    dataset_dict = {
        "datasetVersion": {
            # "license": {
            #     "name": "CC0 1.0",
