...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if testlocal:
            ...
            print(
                "Users have been created with the designated roles for the provided emails. The users still need to accept the invites via email and set OAuth accesses on first login."
            )
