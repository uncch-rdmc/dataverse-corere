...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--crude",
            action="store_true",
            help="Runs the crude deletion, which does not require an intact LocalContainerInfo and stack. The only downside to this is currently if you delete the last containers via this method, the creation of your first containers is very slow.",
        )
