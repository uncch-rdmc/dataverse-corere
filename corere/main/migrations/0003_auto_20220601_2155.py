...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={
                "permissions": [
                    ("change_manuscript_files", "Can manage files for a manuscript"),
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, help_text="TODO", verbose_name="Are you restricted from sharing this data with Odum for verification only?"
            ),
        ),
        migrations.AddField(
            model_name="historicalmanuscript",
        ...
        migrations.AddField(
            ...
            field=models.DateField(
                blank=True, help_text="The date the dataset in Dataverse was published", null=True, verbose_name="Dataset Publish Date"
            ),
        ),
        migrations.AddField(
            model_name="historicalmanuscript",
        ...
        migrations.AddField(
            ...
            name="packages_info",
            field=models.TextField(
                default="", help_text="Please provide the list of your required packages and their versions.", verbose_name="Required Packages"
            ),
        ),
        migrations.AddField(
            model_name="historicalmanuscript",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ("code", "Code"),
                    ("data", "Data"),
                    ("documentation_readme", "Documentation - Readme"),
                    ("documentation_codebook", "Documentation - Codebook"),
                    ("documentation_other", "Documentation - Other"),
                ],
                max_length=32,
                null=True,
        ...
        migrations.AlterField(
            ...
            field=django_fsm.FSMField(
                choices=[
                    ("new", "New"),
                    ("awaiting_initial", "Awaiting Initial Submission"),
                    ("awaiting_resubmission", "Awaiting Author Resubmission"),
                    ("reviewing", "Editor Reviewing"),
                    ("processing", "Processing Submission"),
                    ("pending_dataverse_publish", "Pending Dataverse Publish"),
                    ("published_to_dataverse", "Published To Dataverse"),
                    ("completed_report_sent", "Completed Report Sent"),
                ],
                default="new",
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False, help_text="TODO", verbose_name="Does this manuscript require a high-performance compute environment?"
            ),
        ),
        migrations.AlterField(
            model_name="historicalmanuscript",
            name="qdr_review",
            field=models.BooleanField(
                default=False, help_text="TODO", verbose_name="Does this manuscript need verification of qualitative results by QDR?"
            ),
        ),
        migrations.AlterField(
            model_name="historicalmanuscript",
        ...
        migrations.AlterField(
            ...
            field=django_fsm.FSMField(
                choices=[
                    ...
                    ("rejected_editor", "Rejected Editor"),
                    ...
                    ("reviewed_awaiting_approval", "Reviewed Report Awaiting Approval"),
                    ("returned", "Returned"),
                ],
                default="new",
        ...
        migrations.AlterField(
            ...
            field=django_fsm.FSMField(
                choices=[
                    ...
                    ("minor_issues", "Minor Issues"),
                    ("major_issues", "Major Issues"),
                    ("success_with_modification", "Success with Modification"),
                    ("success", "Success"),
                ],
                default="new",
