# Generated by Django 2.2.15 on 2020-10-27 15:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('code', 'code'), ('data', 'data'), ('documentation', 'documentation')], max_length=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_status', django_fsm.FSMField(choices=[('new', 'New'), ('awaiting_init', 'Awaiting Initial Submission'), ('awaiting_resub', 'Awaiting Resubmission'), ('reviewing', 'Reviewing Submission'), ('processing', 'Processing Submission'), ('completed', 'Completed')], default='new', max_length=15)),
