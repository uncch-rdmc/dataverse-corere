    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('-', '-'), ('code', 'Code'), ('data', 'Data'), ('doc_readme', 'Documentation - Readme'), ('doc_codebook', 'Documentation - Codebook'), ('doc_other', 'Documentation - Other')], default='-', max_length=14, verbose_name='file type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producer_first_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='Producer First Name')),
                ('producer_last_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='Producer Last Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Date model was created', verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date model was last updated', verbose_name='updated at')),
                ('operating_system', models.CharField(blank=True, default='', max_length=200, null=True, verbose_name='Operating System')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(blank=True, default='', max_length=200, verbose_name='Version')),
                ('source_default_repo', models.BooleanField(blank=True, default=False, verbose_name='Source - Default Repository')),
                ('source_cran', models.BooleanField(blank=True, default=False, verbose_name='Source - CRAN')),
                ('source_author_website', models.BooleanField(blank=True, default=False, verbose_name='Source - Author Website')),
                ('source_dataverse', models.BooleanField(blank=True, default=False, verbose_name='Source - Dataverse Archive')),
                ('source_other', models.CharField(blank=True, default='', max_length=200, null=True, verbose_name='Source - Other')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_file', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='main.gitfile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_file', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='main.gitfile')),
