    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True,
                default="",
                help_text="Additional info about the manuscript (e.g., approved exemptions, restricted data, etc).",
                max_length=1024,
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name="+", to="main.manuscript"
            ),
        ),
        migrations.AddField(
            model_name="historicalverificationmetadata",
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                default=0, on_delete=django.db.models.deletion.CASCADE, related_name="manuscript_vmetadata", to="main.manuscript"
            ),
        ...
        migrations.AddField(
            ...
            name="manuscript",
            field=models.ForeignKey(
                default=0, on_delete=django.db.models.deletion.CASCADE, related_name="verificationmetadata_audits", to="main.manuscript"
            ),
            preserve_default=False,
        ),
        migrations.AddField(
            ...
            name="manuscript",
            field=models.ForeignKey(
                default=0, on_delete=django.db.models.deletion.CASCADE, related_name="verificationmetadata_badges", to="main.manuscript"
            ),
            preserve_default=False,
        ),
        ...
        migrations.AlterField(
            ...
            name="_status",
            field=django_fsm.FSMField(
                choices=[("new", "---"), ("issues", "Issues"), ("no_issues", "No Issues")],
                default="new",
        ...
        migrations.AlterField(
            ...
            field=django_fsm.FSMField(
                choices=[
                    ...
                    ("awaiting_resub", "Awaiting Author Resubmission"),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                help_text="Surname of the publication contact that will be stored in Dataverse",
                max_length=150,
                verbose_name="Corresponding Author Surname",
            ),
        ),
        migrations.AlterField(
            model_name="historicalmanuscript",
            name="description",
            field=models.TextField(
                blank=True, default="", help_text="The abstract for the manuscript", max_length=1024, null=True, verbose_name="Abstract"
            ),
        ),
        migrations.AlterField(
            model_name="historicalmanuscript",
            name="pub_id",
            field=models.CharField(
                db_index=True, default="", help_text="The internal ID from the publication", max_length=200, verbose_name="Manuscript #"
            ),
        ),
        migrations.AlterField(
            model_name="historicalmanuscript",
            ...
            field=models.BooleanField(
                blank=True,
                default=False,
                help_text="Does this manuscript need verification of qualitative results by QDR?",
                null=True,
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                blank=True,
                default=False,
                help_text="Whether this manuscript includes qualitative analysis",
                null=True,
        ...
        migrations.AlterField(
            ...
            field=django_fsm.FSMField(
                choices=[
                    ...
                    ("minor_issues", "Minor Issues"),
                    ("major_issues", "Major Issues"),
                    ("success_w_mod", "Success with Modification"),
                    ("success", "Success"),
                ],
                default="new",
        ...
        migrations.AddField(
            ...
            name="manuscript",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="manuscript_localcontainerinfo", to="main.manuscript"
            ),
        ),
        migrations.AddField(
            ...
            name="user",
            field=models.OneToOneField(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name="invite", to=settings.AUTH_USER_MODEL
            ),
        ),
    ]
