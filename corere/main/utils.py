...
### GITLAB ###
# Note: There is a gitlab python library, but I decided not to use it as I'm already having to shape browser calls as well...
#       That being said, if more calls than these are needed we may want to switch over
