...
def manuscript_landing(request, id=None):
    ...
    if has_transition_perm(manuscript.add_submission_noop, request.user) :
        ...
        try:
            ...
            if not (returnSubmissionButton or sendReportButton or reviewSubmissionButtonMain or dataverseUploadManuscriptButtonMain or dataverseUploadManuscriptButtonMore or updateReviewSubmissionButtonMain or updateReviewSubmissionButtonMore) \
